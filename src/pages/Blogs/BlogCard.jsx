    ...
    <section>
      <div className="py-10">
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          <img className="w-full" src={crudImg} alt="Sunset in the mountains" />
          ...
          <div className="flex justify-between px-6 pt-4 pb-2">
            <div className="">
              <span className="inline-block rounded-full px-3 py-1 text-sm font-semibold text-gray-700  mb-2">
            ...
            <div className="">
              <span className="inline-block rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-1 mb-2">
